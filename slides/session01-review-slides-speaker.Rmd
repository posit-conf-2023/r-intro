...
And we the Academy team will be guiding you as you do this...
...
.center[
```{r echo=FALSE}
knitr::include_graphics("images/session01/daily-schedule.png")
```
]
...
But turn your audio and camera off. The only thing necessary is screensharing, which we'll take turns doing as usual.
...
Looks like the most common primary mode for outbreaks in this particular dataset is person-to-person.
