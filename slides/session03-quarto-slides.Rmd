...
knitr::include_graphics("images/session03-quarto/academy-rmd.png")
```
...
knitr::include_graphics("images/session03-quarto/rmd-anatomy.jpeg")
```
]
...
.center[
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("images/session03-quarto/knit_explained.png")
```
]
...
knitr::include_graphics("images/session03-quarto/cheatsheet-markdown.png")
```
...
knitr::include_graphics("images/session03-quarto/rmarkdown-insert.gif")
```
]
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("images/session03-quarto/cheatsheet-knitr.png")
```
...
.pull-left[
```{r echo=FALSE}
knitr::include_graphics("images/session03-quarto/output-format-cheatsheet.png")
```
]

.pull-right[
```{r echo=FALSE, out.width = "70%"}
knitr::include_graphics("images/session03-quarto/output-formats.png")
```
]
...
```{r echo=FALSE, out.width="100%"}
knitr::include_graphics("images/session03-quarto/cheatsheet-yaml.png")
```
...
```{r echo=FALSE, out.width="50%"}
knitr::include_graphics("images/session03-quarto/open.gif")
```
