...
- rounding times (e.g. nearest week or month)
...
```
???
And here is the filtered result, which is now subset of the original data containing only the records with had a timestamp within one week of labor day. 
...
knitr::include_graphics("images/session07/stickies.png")
```
